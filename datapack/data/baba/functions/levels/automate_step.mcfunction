...
execute if score win baba matches 1 run function baba:levels/automate_finished
execute if score win baba matches 0 unless data storage baba:main moves[0] run function baba:levels/automate_finished
