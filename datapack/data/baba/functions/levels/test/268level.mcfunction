function baba:levels/268level
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [4,4,2,2,2,3,2,4,4,4,4,4,4,1,4,2,4,2,1,1,3,1,4,3,1,1,1,4,2,2,2,3,3,3,3,3,2,2,3,3,3,3,3,3,2,3,2,3,4,1,4,4,4,4,4,4,4,4,4,4,4,0,0,2,2,4,4,4,4,4,1,1,1,1,1]
