function baba:levels/52level
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [1,1,1,1,1,3,1,1,4,4,1,4,4,4,1,1,1,2,4,1,1,3,4,4,1,3,3,4,4,4,2,2,2,2,2,2,4,4,4,2,2,2,4,4,4,4,4]
