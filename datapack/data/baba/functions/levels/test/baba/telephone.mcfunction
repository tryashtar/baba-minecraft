# test "telephone" in 51 moves
function baba:levels/load/baba/telephone
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [2,4,4,4,4,4,4,4,4,2,3,1,2,3,3,2,2,4,1,2,3,3,3,1,3,1,4,1,1,1,1,4,4,4,4,2,3,2,2,2,1,1,1,4,4,4,4,4,4,4,4]
