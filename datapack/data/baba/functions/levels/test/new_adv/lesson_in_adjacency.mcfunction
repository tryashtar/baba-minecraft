# test "Lesson in adjacency" in 35 moves
function baba:levels/load/new_adv/lesson_in_adjacency
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [4,4,4,1,1,4,4,2,2,4,4,4,4,4,4,4,4,1,1,1,1,2,4,1,2,4,1,4,2,3,2,2,2,2,3]
