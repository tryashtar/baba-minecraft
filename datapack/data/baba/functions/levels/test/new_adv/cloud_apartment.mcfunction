# test "Cloud apartment" in 47 moves
function baba:levels/load/new_adv/cloud_apartment
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [3,2,4,4,4,3,3,2,4,4,1,4,3,2,4,3,3,3,3,1,1,1,3,1,4,2,4,1,3,3,1,4,4,4,4,1,4,2,2,4,4,0,0,4,4,4,4]
