...
execute unless data storage baba:main props[0] if data storage baba:main tiles[0] run function baba:board/properties/property_next
execute if data storage baba:main tiles[0] run function baba:board/properties/property_loop
