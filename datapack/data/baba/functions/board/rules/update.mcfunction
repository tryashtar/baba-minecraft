...
execute as @e[type=marker,tag=baba.rule] run scoreboard players operation @s last_disabled = @s text_disabled

# apply incoming/outgoing disablers to pre-existing rules
tag @e[type=marker,tag=baba.rule,tag=!effect_inverted,tag=!changed] add target
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=disabler,tag=changed] run function baba:board/rules/disabling/disabler_changed
tag @e[type=marker,tag=baba.rule,tag=target] remove target

# apply incoming/pre-existing disablers to incoming rules
tag @e[type=marker,tag=baba.rule,tag=!effect_inverted,tag=changed,tag=!remove] add target
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=disabler,tag=!remove] run function baba:board/rules/disabling/disabler_changed
tag @e[type=marker,tag=baba.rule,tag=target] remove target

# apply newly-changed pre-existing transformer disablers to pre-existing transformers
tag @e[type=marker,tag=baba.rule,tag=transformer,tag=!changed] add target
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=!changed,scores={last_disabled=0,text_disabled=1..}] run function baba:board/rules/disabling/transform_disabler_changed
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=!changed,scores={last_disabled=1..,text_disabled=0}] run function baba:board/rules/disabling/transform_disabler_changed

# apply enabled incoming/outgoing transformer disablers to pre-existing transformers
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=changed,scores={text_disabled=0}] run function baba:board/rules/disabling/transform_disabler_changed
tag @e[type=marker,tag=baba.rule,tag=target] remove target

# apply enabled incoming/pre-existing transformer disablers to incoming transformers
tag @e[type=marker,tag=baba.rule,tag=transformer,tag=changed,tag=!remove] add target
execute if entity @e[type=marker,tag=baba.rule,tag=target,limit=1] as @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=!remove,scores={text_disabled=0}] run function baba:board/rules/disabling/transform_disabler_changed
tag @e[type=marker,tag=baba.rule,tag=target] remove target

# apply disabled outgoing rules
execute as @e[type=marker,tag=baba.rule,tag=!effect_inverted,tag=remove,scores={text_disabled=1..}] run data modify storage baba:main enabled_ids append from entity @s data.text_ids[]

execute as @e[type=marker,tag=baba.rule,scores={last_disabled=0,text_disabled=1..}] run data modify storage baba:main disabled_ids append from entity @s data.text_ids[]
execute as @e[type=marker,tag=baba.rule,scores={last_disabled=1..,text_disabled=0}] run data modify storage baba:main enabled_ids append from entity @s data.text_ids[]
