...
execute if data storage baba:main rule.subject{inverted:1b} as @e[type=marker,tag=baba.object,tag=!not_all] at @s unless score @s sprite = subject baba run function baba:board/rules/apply/check
