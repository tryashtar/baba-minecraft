...
execute if score different baba matches 0 if score different2 baba matches 0 if data storage baba:main rule{verb:"is",effect:{sprite:"text"}} if data storage baba:main normal_rules[0].effect{verb:"write"} run function baba:board/rules/disable
execute if score different baba matches 0 if score different2 baba matches 1 if data storage baba:main rule{verb:"is"} if data storage baba:main normal_rules[0].effect{verb:"is"} run function baba:board/rules/enable
execute if score different baba matches 0 if data storage baba:main rule{verb:"is"} if data storage baba:main normal_rules[0].effect{verb:"write"} run function baba:board/rules/enable
...
execute if score different baba matches 0 if score different2 baba matches 0 run function baba:board/rules/disable
