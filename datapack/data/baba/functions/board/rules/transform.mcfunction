...
execute if data storage baba:main transform{verb:"is"} run data modify storage baba:main spawn set from storage baba:main transform.sprite
...
execute if data storage baba:main transform{verb:"is",sprite:"text"} run data modify storage baba:main spawn_text set from entity @s data.sprite
