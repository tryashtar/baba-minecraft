...
execute if score changed baba >= size baba unless data storage baba:main effect{text:1065,inverted:0b} run data modify entity @s[type=item_display] item.tag.parsing.make append from storage baba:main effect
execute if score changed baba >= size baba unless data storage baba:main effect{text:1065,inverted:0b} run data modify entity @s[type=marker] data.parsing.make append from storage baba:main effect
