...
execute if entity @s[type=item_display] if score changed baba >= size baba unless data storage baba:main effect{text:1065,inverted:0b} run data modify entity @s item.tag.parsing.make append from storage baba:main effect
execute if entity @s[type=marker] if score changed baba >= size baba unless data storage baba:main effect{text:1065,inverted:0b} run data modify entity @s data.parsing.make append from storage baba:main effect
...
execute if score changed baba >= size baba if data storage baba:main effect{text:1065,inverted:0b} run function baba:board/rules/apply/make_all
