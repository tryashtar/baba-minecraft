...
data modify storage baba:main check append from entity @s item.tag.parsing.make[{inverted:1b}].text
...
execute if score changed baba >= size baba run data modify entity @s item.tag.parsing.make append from storage baba:main effect
