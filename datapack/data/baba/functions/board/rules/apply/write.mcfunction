...
data modify storage baba:main check append from entity @s item.tag.parsing.writes[{inverted:1b}].text
...
execute if score changed baba >= size baba run data modify entity @s item.tag.parsing.writes append from storage baba:main rule.effect
