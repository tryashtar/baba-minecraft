...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s HandItems[0].tag.parsing.writes[].text_text
...
execute if score after baba > before baba run data modify entity @s HandItems[0].tag.parsing.writes append from storage baba:main rule.effect
