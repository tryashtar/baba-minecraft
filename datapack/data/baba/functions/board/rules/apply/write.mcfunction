...
execute if score changed baba >= size baba run data modify entity @s[type=item_display] item.tag.parsing.writes append from storage baba:main effect
execute if score changed baba >= size baba run data modify entity @s[type=marker] data.parsing.writes append from storage baba:main effect
