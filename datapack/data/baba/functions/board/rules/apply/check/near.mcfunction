...
execute if data storage baba:main condition{inverted:0b} as @e[type=marker,tag=baba.object,tag=!self,distance=..1.5] if score @s sprite = check_sprite baba run scoreboard players set passes baba 1
execute if data storage baba:main condition{inverted:1b} as @e[type=marker,tag=baba.object,tag=!self,distance=..1.5] unless score @s sprite matches 30442 if score @s sprite = check_sprite baba run scoreboard players set passes baba 1
