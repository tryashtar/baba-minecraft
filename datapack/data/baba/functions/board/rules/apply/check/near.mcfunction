...
execute if score inverted baba matches 0 as @e[type=armor_stand,tag=baba.object,tag=!self,tag=!used,distance=..1.5] if score @s sprite = check_sprite baba run tag @s add found
