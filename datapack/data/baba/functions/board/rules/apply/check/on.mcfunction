...
execute if score inverted baba matches 0 run tag @e[type=#baba:object,tag=baba.object,tag=!self,tag=!used,predicate=baba:same_sprite,distance=..0.1] add found
execute if score inverted baba matches 1 run tag @e[type=#baba:object,tag=baba.object,tag=!self,tag=!used,tag=!not_all,predicate=!baba:same_sprite,distance=..0.1] add found
