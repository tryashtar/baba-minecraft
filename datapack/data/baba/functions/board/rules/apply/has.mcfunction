...
execute if score changed baba >= size baba run data modify entity @s[type=item_display] item.tag.parsing.has append from storage baba:main effect
execute if score changed baba >= size baba run data modify entity @s[type=marker] data.parsing.has append from storage baba:main effect
