...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s item.tag.parsing.has[].text_text
...
execute if score after baba > before baba run data modify entity @s item.tag.parsing.has append from storage baba:main rule.effect
