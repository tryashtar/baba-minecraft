...
data modify storage baba:main check append from entity @s item.tag.parsing.has[{inverted:1b}].text
...
execute if score changed baba >= size baba run data modify entity @s item.tag.parsing.has append from storage baba:main rule.effect
