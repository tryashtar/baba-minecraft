...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s data.properties[{inverted:1b}].text
...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags set value ["."]
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s data.transforms[{verb:"is",inverted:1b}].text
...
execute unless data entity @s data.transforms[{verb:"is",inverted:1b,text:"text"}] run data modify storage baba:main writes append from entity @s data.transforms[{verb:"write",inverted:0b}]
...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags set value ["."]
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s data.has[{inverted:1b}].text
...
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags set value ["."]
data modify entity aee4e839-6b46-4f38-97f8-d49dfe743ff1 Tags append from entity @s data.make[{inverted:1b}].text
