...
execute if entity @s[type=item_display] if score changed baba >= size baba run data modify entity @s item.tag.parsing.transforms append from storage baba:main apply_all[0]
execute if entity @s[type=marker] if score changed baba >= size baba run data modify entity @s data.parsing.transforms append from storage baba:main apply_all[0]

data remove storage baba:main apply_all[0]
execute if data storage baba:main apply_all[0] run function baba:board/rules/apply/transform_all
