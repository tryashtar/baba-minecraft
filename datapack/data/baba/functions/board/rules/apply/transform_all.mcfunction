...
execute if score changed baba >= size baba run data modify entity @s[type=item_display] item.tag.parsing.transforms append from storage baba:main apply_all[0]
execute if score changed baba >= size baba run data modify entity @s[type=marker] data.parsing.transforms append from storage baba:main apply_all[0]
