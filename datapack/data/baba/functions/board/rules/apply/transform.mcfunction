...
execute if entity @s[type=item_display] if score effect baba = @s sprite if data storage baba:main effect{inverted:1b} run data modify entity @s item.components."minecraft:custom_data".parsing.delete set value 1b
execute if entity @s[type=item_display] if score effect baba = @s sprite if data storage baba:main effect{inverted:0b} run data modify entity @s item.components."minecraft:custom_data".parsing.block_transforms set value 1b
