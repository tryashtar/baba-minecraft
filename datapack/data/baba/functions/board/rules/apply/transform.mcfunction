...
data modify storage baba:main check append from entity @s item.tag.parsing.transforms[].text
...
execute if score changed baba >= size baba run data modify entity @s item.tag.parsing.transforms append from storage baba:main rule.effect
