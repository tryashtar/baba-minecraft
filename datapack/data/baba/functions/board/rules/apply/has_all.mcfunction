...
execute if entity @s[type=item_display] if score changed baba >= size baba run data modify entity @s item.tag.parsing.has append from storage baba:main apply_all[0]
execute if entity @s[type=marker] if score changed baba >= size baba run data modify entity @s data.parsing.has append from storage baba:main apply_all[0]
