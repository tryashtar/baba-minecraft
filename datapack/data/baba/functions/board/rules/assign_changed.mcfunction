...
execute if entity @s[tag=!subject_all,tag=!subject_group] as @e[type=#baba:object,tag=baba.object,tag=!assign] if score @s sprite = subject baba run tag @s add assign
