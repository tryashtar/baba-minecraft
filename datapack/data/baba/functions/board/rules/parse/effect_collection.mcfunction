...
execute if data storage baba:main rule{verb:"write"} positioned as @s positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,distance=..0.1,nbt={data:{sprite:"text"}}] run function baba:board/rules/parse/append/text_effect
