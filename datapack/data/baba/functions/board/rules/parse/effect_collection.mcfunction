...
execute positioned as @s[nbt={data:{text:"is"}}] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=part.property,distance=..0.1] run function baba:board/rules/parse/append/property_effect
execute positioned as @s[nbt={data:{text:"write"}}] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,distance=..0.1] run function baba:board/rules/parse/append/property_effect
