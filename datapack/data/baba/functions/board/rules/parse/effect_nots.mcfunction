...
execute if entity @e[type=item_display,tag=baba.object,tag=last_verb,tag=accepts_noun,tag=accepts_property,limit=1] positioned ^ ^ ^1 run tag @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.property,tag=!part.noun,distance=..0.1] add first_word
execute if entity @e[type=item_display,tag=baba.object,tag=last_verb,tag=!accepts_noun,tag=accepts_property,limit=1] positioned ^ ^ ^1 run tag @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.property,distance=..0.1] add first_word
execute if entity @e[type=item_display,tag=baba.object,tag=last_verb,tag=accepts_noun,tag=!accepts_property,limit=1] positioned ^ ^ ^1 run tag @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.noun,distance=..0.1] add first_word
