...
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=accepts_noun,tag=accepts_property,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=is_text,tag=!part.not,tag=!part.property,tag=!part.noun,distance=..0.1] run function baba:board/rules/parse/new
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=!accepts_noun,tag=accepts_property,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=is_text,tag=!part.not,tag=!part.property,distance=..0.1] run function baba:board/rules/parse/new
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=accepts_noun,tag=!accepts_property,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=is_text,tag=!part.not,tag=!part.noun,distance=..0.1] run function baba:board/rules/parse/new
