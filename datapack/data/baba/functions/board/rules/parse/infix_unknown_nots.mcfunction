...
execute positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=is_text,tag=!part.not,tag=!part.infix,tag=!part.noun,distance=..0.1] run function baba:board/rules/parse/new
