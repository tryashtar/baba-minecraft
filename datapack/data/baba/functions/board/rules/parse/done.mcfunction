...
execute if entity @s[tag=part.noun] if entity @e[type=armor_stand,tag=baba.object,scores={sprite=30442},distance=..0.1,limit=1] positioned ^ ^ ^-1 run function baba:board/rules/parse/new
