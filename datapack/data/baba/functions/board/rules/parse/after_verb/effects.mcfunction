...
# 'write' is special, supports nouns and properties in the same manner
execute if data storage baba:main {verb:"write"} positioned as @s positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=part.property,distance=..0.1] run function baba:board/rules/parse/after_verb/finalize/text
execute if data storage baba:main {verb:"write"} positioned as @s positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=part.noun,distance=..0.1] run function baba:board/rules/parse/after_verb/finalize/text
# other verbs only support nouns
execute unless data storage baba:main {verb:"write"} positioned as @s positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=part.noun,distance=..0.1] run function baba:board/rules/parse/after_verb/finalize/noun
# 'is' supports properties
