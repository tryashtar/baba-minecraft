...
data modify storage baba:main pending_rules[].effect.text set from entity @s data.text
data modify storage baba:main pending_rules[].effect.type set value "text"
