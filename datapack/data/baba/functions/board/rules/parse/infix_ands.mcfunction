...
execute positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,tag=is_text,tag=!part.not,tag=!part.noun,tag=!part.infix,distance=..0.1] run function baba:board/rules/parse/new
