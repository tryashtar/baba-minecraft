...
execute if data storage baba:main infixes[0] positioned as @s positioned ^ ^ ^1 if entity @e[type=marker,tag=baba.object,tag=part.operator,distance=..0.1,nbt={data:{text:"and"}}] positioned ^ ^ ^1 run function baba:board/rules/parse/infix_collection
