...
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=accepts_property,tag=accepts_noun,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,scores={sprite=30442},tag=!part.not,tag=!part.noun,tag=!part.property,tag=!part.verb,distance=..0.1] run function baba:board/rules/parse/new
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=!accepts_property,tag=accepts_noun,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,scores={sprite=30442},tag=!part.not,tag=!part.noun,tag=!part.verb,distance=..0.1] run function baba:board/rules/parse/new
execute if entity @e[type=marker,tag=baba.object,tag=last_verb,tag=accepts_property,tag=!accepts_noun,limit=1] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,scores={sprite=30442},tag=!part.not,tag=!part.property,tag=!part.verb,distance=..0.1] run function baba:board/rules/parse/new
