...
execute positioned ^ ^ ^1 unless entity @e[type=item_display,tag=baba.object,tag=part.not,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.noun,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.verb,distance=..0.1,limit=1] if entity @e[type=item_display,tag=baba.object,tag=last_verb,tag=accepts_noun,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.noun,distance=..0.1,limit=1] run function baba:board/rules/parse/done
execute positioned ^ ^ ^1 unless entity @e[type=item_display,tag=baba.object,tag=part.not,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.noun,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.verb,distance=..0.1,limit=1] if entity @e[type=item_display,tag=baba.object,tag=last_verb,tag=accepts_property,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=part.property,distance=..0.1,limit=1] run function baba:board/rules/parse/done
