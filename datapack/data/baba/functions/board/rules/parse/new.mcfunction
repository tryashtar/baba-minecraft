...
execute if score cleanup baba matches 1 as @e[type=marker,tag=baba.object,scores={sprite=30442}] run function baba:board/rules/parse/reset
...
execute if entity @s[tag=!part.not,tag=!part.prefix,tag=!part.noun] positioned ^ ^ ^1 as @e[type=marker,tag=baba.object,scores={sprite=30442},distance=..0.1] run function baba:board/rules/parse/new
