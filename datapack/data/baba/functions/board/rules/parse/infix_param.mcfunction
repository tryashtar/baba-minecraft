...
execute positioned ^ ^ ^1 as @e[type=armor_stand,tag=baba.object,tag=reparse,tag=!part.and,tag=!part.verb,distance=..0.1] run function baba:board/rules/parse/new
