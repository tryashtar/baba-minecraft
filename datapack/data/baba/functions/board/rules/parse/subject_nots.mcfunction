...
execute positioned ^ ^ ^1 as @e[type=armor_stand,tag=baba.object,tag=baba.object,tag=!part.not,tag=!part.noun,scores={sprite=30442},distance=..0.1] run function baba:board/rules/parse/new
