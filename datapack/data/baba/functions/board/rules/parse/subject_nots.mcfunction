...
execute positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,tag=baba.object,tag=!part.not,tag=!part.noun,tag=reparse,distance=..0.1] run function baba:board/rules/parse/new
