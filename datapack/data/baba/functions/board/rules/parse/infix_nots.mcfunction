...
execute positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.infix,distance=..0.1] run function baba:board/rules/parse/new
