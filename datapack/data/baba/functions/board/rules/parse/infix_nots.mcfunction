...
execute positioned ^ ^ ^1 as @e[type=armor_stand,tag=baba.object,scores={sprite=30442},tag=!part.not,tag=!part.infix,distance=..0.1] run function baba:board/rules/parse/new
