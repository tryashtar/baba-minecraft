...
execute unless data storage baba:main parsing.state{and:"none"} run data modify storage baba:main parsing.all_ids append from storage baba:main parsing.word_ids[]
