...
execute positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.and,tag=!part.infix,tag=!part.verb,distance=..0.1] run function baba:board/rules/parse/new
