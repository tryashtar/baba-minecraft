...
execute if entity @s[nbt={item:{tag:{text:"facing"}}}] positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,scores={direction=1..},distance=..0.1] run function baba:board/rules/parse/infix_param
execute if entity @s[nbt={item:{tag:{text:"facing"}}}] positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.noun,distance=..0.1] unless score @s direction matches 1.. run function baba:board/rules/parse/new
execute if entity @s[nbt=!{item:{tag:{text:"facing"}}}] positioned ^ ^ ^1 as @e[type=item_display,tag=baba.object,tag=reparse,tag=!part.not,tag=!part.noun,distance=..0.1] run function baba:board/rules/parse/new
