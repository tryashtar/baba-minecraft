...
execute if entity @s[tag=inverted_subject,tag=all_subject] as @e[type=item_display,tag=baba.object,tag=assign,scores={sprite=2925313}] at @s run function baba:board/rules/apply/check
execute if entity @s[tag=inverted_subject,tag=all_subject] as @e[type=item_display,tag=baba.object,tag=assign,scores={sprite=397973}] at @s run function baba:board/rules/apply/check
