...
execute if data storage baba:main rule{verb:"is"}.effect{inverted:0b,part:"noun"} unless data storage baba:main rule.conditions[0] run function baba:board/rules/graphics/check_transform_disable
