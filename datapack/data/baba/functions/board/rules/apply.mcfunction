...
execute if data storage baba:main rule{inverted:0b} as @e[type=marker,tag=baba.object] at @s if score @s sprite = subject baba run function baba:board/rules/apply/rule
execute if data storage baba:main rule{inverted:1b} as @e[type=marker,tag=baba.object] at @s unless score @s sprite matches 30442 unless score @s sprite = subject baba run function baba:board/rules/apply/rule
