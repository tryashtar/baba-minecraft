...
execute if data storage baba:main rule.effect{inverted:1b} unless data storage baba:main rule.conditions[0] run function baba:board/rules/disabling
execute if data storage baba:main rule.effect{inverted:0b,verb:"is",type:"noun"} unless data storage baba:main rule.conditions[0] run function baba:board/rules/check_transform_disable
