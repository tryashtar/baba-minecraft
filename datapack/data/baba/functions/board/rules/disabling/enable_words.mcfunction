...
scoreboard players remove @e[type=item_display,tag=baba.object,tag=is_text,predicate=baba:same_text_id] text_disabled 1
tag @e[type=item_display,tag=baba.object,tag=is_text,predicate=baba:same_text_id] add disable_changed
