...
scoreboard players operation @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=!changed] sprite -= subject baba
scoreboard players operation @e[type=marker,tag=baba.rule,tag=transform_disabler,tag=!changed] text -= subject baba
