...
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=!subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group] text_disabled += disable_change baba
...
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=subject_empty] text_disabled += disable_change baba
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=subject_text] text_disabled += disable_change baba
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=subject_inverted,tag=subject_all] text_disabled += disable_change baba
...
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=!subject_all,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,scores={sprite=1..}] text_disabled += disable_change baba
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=!subject_all,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,scores={sprite=..-1}] text_disabled += disable_change baba
...
execute if score verb baba matches 262 if score effect baba matches 397973 if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=subject_inverted,scores={sprite=0}] text_disabled += disable_change baba
