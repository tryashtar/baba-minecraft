...
execute if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=!subject_inverted,tag=!subject_all,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,predicate=baba:same_life,predicate=baba:same_text,predicate=!baba:same_sprite] text_disabled += disable_change baba
# 'not A is not text' disables 'B write X' unless B is all/empty/text/level/group
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=!subject_all,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,predicate=!baba:same_sprite] text_disabled += disable_change baba
# 'not A verb not X' disables 'not A verb X'
execute if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=subject_inverted,predicate=baba:same_life,predicate=baba:same_text,predicate=baba:same_sprite] text_disabled += disable_change baba
# 'not A is not text' disables 'not A write X'
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=subject_inverted,predicate=baba:same_sprite] text_disabled += disable_change baba
