...
execute if data storage baba:main disabled_ids[0] as @e[type=item_display,tag=baba.object,scores={text_id=1..}] if score @s text_id = disable baba run scoreboard players add @s text_disabled 1
data remove storage baba:main disabled_ids[0]
execute if data storage baba:main disabled_ids[0] store result score disable baba run data get storage baba:main disabled_ids[0]
execute if data storage baba:main disabled_ids[0] as @e[type=item_display,tag=baba.object,scores={text_id=1..}] if score @s text_id = disable baba run scoreboard players add @s text_disabled 1
data remove storage baba:main disabled_ids[0]
