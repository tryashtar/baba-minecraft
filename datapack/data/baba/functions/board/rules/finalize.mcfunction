...
execute if entity @s[scores={sprite=397973}] unless data storage baba:main rule_data.parsing.properties[{inverted:1b,text_text:"push"}] run data modify storage baba:main rule_data.properties append value "push"
...
execute if entity @s[scores={sprite=54575550}] unless data storage baba:main rule_data.parsing.properties[{inverted:1b,text_text:"select"}] run data modify storage baba:main rule_data.properties append value "select"
