...
data modify storage baba:main rule.prefixes set from storage baba:main prefix_collection
data modify storage baba:main rule.infixes set from storage baba:main infix_collection
data modify storage baba:main rule.affected set from storage baba:main noun_collection
