...
data modify storage baba:main verb set from storage baba:main normal_rules[0].verb
...
execute if score subject1 baba = subject2 baba if score subject1 baba = effect baba if data storage baba:main {verb:12584543} run function baba:board/rules/graphics/transform_disable
