...
execute as @e[type=armor_stand,tag=baba.object,scores={text_id=1..}] if score @s text_id = disable baba run scoreboard players add @s[scores={text_disabled2=0..}] text_disabled2 1
