...
# negative rules disable positive rules
...
# 'A is A' disables other transforms
...
execute if score subject baba = effect baba if data storage baba:main rule{verb:262,subject:{inverted:0b},effect:{part:"noun",inverted:0b}} unless data storage baba:main rule.conditions[0] run function baba:board/rules/graphics/transform_disabling
