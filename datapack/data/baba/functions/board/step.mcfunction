...
execute as @e[type=item_display,tag=baba.object,tag=!move_success,nbt={item:{tag:{properties:["move"]}}},nbt=!{item:{tag:{properties:["sleep"]}}}] at @s run function baba:board/movement/attempt/move_turnaround
tag @e[type=item_display,tag=baba.object,tag=move_success] remove move_success
tag @e[type=item_display,tag=baba.object,tag=move_done] remove move_done
...
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["tele"]}}}] at @s run function baba:board/interact/teleport
# shift changes the facing direction of objects both when pushing and when landing
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["shift"]}}}] at @s run function baba:board/movement/process/shift_dir
execute if score direction baba matches 1.. as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["select"]}}}] at @s run function baba:board/movement/select
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["fall"]}}}] at @s run function baba:board/interact/fall
...
scoreboard players set @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["up"]}}}] facing 1
scoreboard players set @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["down"]}}}] facing 2
scoreboard players set @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["left"]}}}] facing 3
scoreboard players set @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["right"]}}}] facing 4
...
scoreboard players set @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["float"]}}}] float_level 1

# assign again if anything is created by 'more', but don't parse text
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["more"]}}}] at @s run function baba:board/interact/more
execute if entity @e[type=item_display,tag=baba.object,tag=assign,limit=1] run function baba:board/rules/assign

execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["sink"]}}}] at @s run function baba:board/interact/sink
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["weak"]}}}] at @s run function baba:board/interact/weak
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["hot"]}}}] at @s run function baba:board/interact/hot
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["defeat"]}}}] at @s run function baba:board/interact/defeat
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["shut"]}}}] at @s run function baba:board/interact/shut
...
execute as @e[type=item_display,tag=baba.object,nbt={item:{tag:{properties:["win"]}}}] at @s run function baba:board/interact/win

# graphical updates
execute as @e[type=item_display,tag=baba.object,tag=connector] at @s run function baba:board/graphics/connector
execute as @e[type=item_display,tag=baba.object,nbt=!{item:{tag:{properties:["sleep"]}}}] run function baba:board/graphics/frame
