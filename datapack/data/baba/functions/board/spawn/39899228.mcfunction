data merge entity @s {teleport_duration:3,width:1f,height:0.1f,item_display:"fixed",Tags:["baba.object","spawn","assign","dirty","has_frames"],item:{id:"potion",components:{custom_data:{text:"bubble"}}}}
