...
execute unless block ~1 ~-1 ~ white_concrete run tag @s add up
...
execute unless block ~-1 ~-1 ~ white_concrete run tag @s add down
...
execute unless block ~ -1~ ~-1 glass white_concrete tag @s add left
...
execute unless block ~ -1~ ~1 glass white_concrete tag @s add right
