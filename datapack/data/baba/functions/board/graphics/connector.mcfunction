...
execute if entity @s[tag=!up] positioned ~1 ~ ~ if entity @e[type=item_display,tag=baba.object,tag=connector,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run tag @s add up
...
execute if entity @s[tag=!down] positioned ~-1 ~ ~ if entity @e[type=item_display,tag=baba.object,tag=connector,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run tag @s add down
...
execute if entity @s[tag=!left] positioned ~ ~ ~-1 if entity @e[type=item_display,tag=baba.object,tag=connector,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run tag @s add left
...
execute if entity @s[tag=!right] positioned ~ ~ ~1 if entity @e[type=item_display,tag=baba.object,tag=connector,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run tag @s add right
