...
execute store result score @e[type=item_display,tag=spawn,distance=..0.1,limit=1] text_disabled run data get storage baba:main previous.objects[0].scores.text_disabled
