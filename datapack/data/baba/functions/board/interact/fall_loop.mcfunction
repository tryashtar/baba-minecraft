...
execute if score open baba matches 1 as @e[type=#baba:object,tag=baba.object,distance=..0.1,tag=prop.shut] if score @s float_level = float baba run tag @s add open
execute if score shut baba matches 1 as @e[type=#baba:object,tag=baba.object,distance=..0.1,tag=prop.open] if score @s float_level = float baba run tag @s add open
...
execute if entity @e[type=#baba:object,tag=baba.object,tag=!falling,distance=..0.1,tag=prop.weak,limit=1] run scoreboard players add destroyed baba 1
execute as @e[type=#baba:object,tag=baba.object,tag=!falling,distance=..0.1,tag=prop.weak] run function baba:board/interact/destroy
