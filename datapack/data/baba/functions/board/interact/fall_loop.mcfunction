...
execute if score open baba matches 1 run tag @e[type=#baba:object,tag=baba.object,tag=prop.shut,predicate=baba:match_score/float_level,distance=..0.1] add open
execute if score shut baba matches 1 run tag @e[type=#baba:object,tag=baba.object,tag=prop.open,predicate=baba:match_score/float_level,distance=..0.1] add open
...
execute if entity @e[type=#baba:object,tag=baba.object,tag=!falling,tag=prop.weak,predicate=baba:match_score/float_level,distance=..0.1,limit=1] run scoreboard players add destroyed baba 1
execute as @e[type=#baba:object,tag=baba.object,tag=!falling,tag=prop.weak,predicate=baba:match_score/float_level,distance=..0.1] run function baba:board/interact/destroy
