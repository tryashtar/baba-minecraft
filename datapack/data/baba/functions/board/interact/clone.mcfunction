...
execute if entity @e[type=item_display,tag=baba.object,distance=..0.1,tag=prop.stop,limit=1] run scoreboard players set clone baba 0
execute if entity @e[type=item_display,tag=baba.object,distance=..0.1,tag=prop.push,limit=1] run scoreboard players set clone baba 0
