...
execute if entity @s[tag=is_text] if entity @e[type=#baba:object,tag=baba.object,predicate=baba:match_score/sprite,predicate=baba:match_score/text,distance=..0.1,limit=1] run return fail
execute if entity @s[tag=!is_text] if entity @e[type=#baba:object,tag=baba.object,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run return fail
