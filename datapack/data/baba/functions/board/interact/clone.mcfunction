...
execute if entity @e[type=#baba:object,tag=baba.object,distance=..0.1,tag=prop.stop,limit=1] run scoreboard players set clone baba 0
execute if entity @e[type=#baba:object,tag=baba.object,distance=..0.1,tag=prop.push,limit=1] run scoreboard players set clone baba 0
execute if entity @e[type=#baba:object,tag=baba.object,distance=..0.1,tag=prop.pull,limit=1] run scoreboard players set clone baba 0
execute if score clone baba matches 1 as @e[type=#baba:object,tag=baba.object,distance=..0.1] if score @s sprite = spawn baba run scoreboard players set clone baba 0
