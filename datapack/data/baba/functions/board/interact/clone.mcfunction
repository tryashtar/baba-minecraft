...
execute if entity @s[tag=is_text] if entity @e[type=#baba:object,tag=baba.object,predicate=baba:same_sprite,predicate=baba:same_text,distance=..0.1,limit=1] run return fail
execute if entity @s[tag=!is_text] if entity @e[type=#baba:object,tag=baba.object,predicate=baba:same_sprite,distance=..0.1,limit=1] run return fail
