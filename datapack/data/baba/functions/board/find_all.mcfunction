...
execute if score sprite baba matches 1.. unless score sprite baba matches 349615 unless score sprite baba matches 5111351 run data modify storage baba:main all_list append from storage baba:main sprite
