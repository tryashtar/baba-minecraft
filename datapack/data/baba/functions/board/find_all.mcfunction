...
execute if score sprite baba matches 1.. unless score sprite baba matches 411311 unless score sprite baba matches 6491892 run data modify storage baba:main all_list append from storage baba:main sprite
