...
execute if entity @e[type=item_display,tag=baba.object,scores={sprite=397973},limit=1] run data modify storage baba:main words.noun append value 397973
...
execute if entity @e[type=item_display,tag=baba.object,scores={sprite=6491892},limit=1] run data modify storage baba:main words.noun append value 6491892
