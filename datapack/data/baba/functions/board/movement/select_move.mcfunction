...
execute if entity @s[tag=!can_move] if entity @e[type=item_display,tag=baba.object,predicate=baba:has_level_data,distance=..0.1,limit=1] run tag @s add can_move
