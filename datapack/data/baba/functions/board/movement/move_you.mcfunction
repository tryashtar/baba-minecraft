...
execute if data storage baba:main props2[0] run function baba:board/check_property
execute if data storage baba:main props2[0] run data modify block ~ ~ ~ RecordItem.tag.tiles set from storage baba:main tiles2
