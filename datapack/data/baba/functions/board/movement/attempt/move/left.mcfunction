data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],facing:3,moved:0b}].moving set value 1b
...
execute if entity @s[tag=!move_success] run data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],facing:3}].facing set value 4
