...
execute if entity @s[tag=!move_success] if data block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:1}] run data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:1}].facing set value 5
...
tag @s[tag=move_success] add moved
execute if entity @s[tag=!move_success] if data block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:2}] run data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:2}].facing set value 1
...
tag @s[tag=move_success] add moved
execute if entity @s[tag=!move_success] if data block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:3}] run data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:3}].facing set value 6
...
tag @s[tag=move_success] add moved
execute if entity @s[tag=!move_success] if data block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:4}] run data modify block ~ ~ ~ RecordItem.tag.tiles[{properties:["move"],moved:0b,facing:4}].facing set value 3
