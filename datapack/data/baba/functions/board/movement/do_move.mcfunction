...
execute as @e[type=armor_stand,tag=baba.object,tag=can_move] positioned as @s run tp @s ^ ^ ^1
...
scoreboard players set @e[type=armor_stand,tag=baba.object,tag=can_move] move_frame 2
