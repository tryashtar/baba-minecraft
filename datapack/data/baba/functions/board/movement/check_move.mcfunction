...
execute if entity @s[tag=can_move,tag=prop.open] positioned ^ ^ ^1 if entity @e[type=item_display,tag=baba.object,tag=prop.shut,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=blocker,tag=!prop.shut,limit=1] run function baba:board/movement/open
execute if entity @s[tag=can_move,tag=prop.shut] positioned ^ ^ ^1 if entity @e[type=item_display,tag=baba.object,tag=prop.open,distance=..0.1,limit=1] unless entity @e[type=item_display,tag=baba.object,tag=blocker,tag=!prop.open,limit=1] run function baba:board/movement/open
