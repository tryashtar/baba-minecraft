...
execute at @s[scores={sprite=349615}] run tag @e[type=item_display,tag=baba.object,scores={sprite=349615},distance=..1.1] add reparse
tp @s ~ ~ ~
tag @s[tag=assign_move] add assign
tag @s[scores={sprite=349615}] add reparse
