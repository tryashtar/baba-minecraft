...
execute at @s[scores={sprite=411311}] run tag @e[type=item_display,tag=baba.object,scores={sprite=411311},distance=..1.1] add reparse
tp @s ~ ~ ~
tag @s[tag=assign_move] add assign
tag @s[scores={sprite=411311}] add reparse
