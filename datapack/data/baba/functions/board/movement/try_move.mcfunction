...
execute positioned ^ ^ ^1 if entity @e[type=marker,tag=baba.tile,tag=!move_handled,nbt={data:{properties:["push"]}},distance=..0.1] positioned ^ ^ ^-1 run function baba:board/movement/try_push
