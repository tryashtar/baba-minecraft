...
execute unless entity @e[type=marker,tag=baba.tile,distance=..0.1,nbt=!{data:{properties:["open"]}},limit=1] positioned ^ ^ ^1 unless entity @e[type=marker,tag=baba.tile,distance=..0.1,nbt=!{data:{properties:["shut"]}},limit=1] run tag @s add move_success
execute unless entity @e[type=marker,tag=baba.tile,distance=..0.1,nbt=!{data:{properties:["shut"]}},limit=1] positioned ^ ^ ^1 unless entity @e[type=marker,tag=baba.tile,distance=..0.1,nbt=!{data:{properties:["open"]}},limit=1] run tag @s add move_success
