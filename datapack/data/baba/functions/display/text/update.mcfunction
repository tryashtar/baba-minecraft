...
execute positioned 0.0 1.0 0.0 as @e[type=marker,tag=baba.space,dz=40] run data modify storage baba:main text append from storage baba:main column
data modify storage baba:main text append from storage baba:main end_column
execute positioned 0.0 1.0 0.0 as @e[type=marker,tag=baba.space,dz=40] run data modify storage baba:main text append value '{"translate":"baba.overlay"}'
...
execute positioned 0.0 1.0 0.0 as @e[type=marker,tag=baba.space,dz=40,sort=nearest] at @s positioned ~-0.5 ~-0.5 ~-0.5 run function baba:display/text/column
