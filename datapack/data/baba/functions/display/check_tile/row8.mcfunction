...
execute if entity @s[nbt={data:{sprite:"fruit"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.fruit.row8","color":"#e5533b"}]'
...
execute if entity @s[nbt={data:{sprite:"box"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.box.row8","color":"#90673e"}]'
execute if entity @s[nbt={data:{sprite:"fire"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.fire.row8","color":"#e49950"}]'
execute if entity @s[nbt={data:{sprite:"gate"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.gate.row8","color":"#e5533b"}]'
...
execute if entity @s[nbt={data:{sprite:"reed"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.reed.row8","color":"#a58d3e"}]'
execute if entity @s[nbt={data:{sprite:"sign"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.sign.row8","color":"#c89c44"}]'
execute if entity @s[nbt={data:{sprite:"sun"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.sun.row8","color":"#e49950"}]'
execute if entity @s[nbt={data:{sprite:"fungi"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.fungi.row8","color":"#c89c44"}]'
execute if entity @s[nbt={data:{sprite:"husk"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.husk.row8","color":"#98643c"}]'
execute if entity @s[nbt={data:{sprite:"leaf"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.leaf.row8","color":"#ede285"}]'
execute if entity @s[nbt={data:{sprite:"orb"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.orb.row8","color":"#d9396a"}]'
execute if entity @s[nbt={data:{sprite:"trees"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.trees.row8","color":"#5c8339"}]'
execute if entity @s[nbt={data:{sprite:"cake"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.cake.row8","color":"#eb91ca"}]'
execute if entity @s[nbt={data:{sprite:"dot"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.dot.row8","color":"#ffffff"}]'
execute if entity @s[nbt={data:{sprite:"foliage"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.foliage.row8","color":"#4b5c1c"}]'
execute if entity @s[nbt={data:{sprite:"rose"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.rose.row8","color":"#e5533b"}]'
execute if entity @s[nbt={data:{sprite:"dust"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.dust.row8","color":"#ede285"}]'
execute if entity @s[nbt={data:{sprite:"fungus"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.fungus.row8","color":"#90673e"}]'
execute if entity @s[nbt={data:{sprite:"husks"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.husks.row8","color":"#90673e"}]'
execute if entity @s[nbt={data:{sprite:"stump"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.stump.row8","color":"#c89c44"}]'
execute if entity @s[nbt={data:{sprite:"level"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.level.row8","color":"#212734"}]'
execute if entity @s[nbt={data:{sprite:"cursor"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.cursor.row8","color":"#eb91ca"}]'
...
execute if entity @s[nbt={data:{sprite:"bird"}}] run function baba:display/check_tile/row8/bird
...
execute if entity @s[nbt={data:{sprite:"bolt"}}] run function baba:display/check_tile/row8/bolt
execute if entity @s[nbt={data:{sprite:"hand"}}] run function baba:display/check_tile/row8/hand
execute if entity @s[nbt={data:{sprite:"bat"}}] run function baba:display/check_tile/row8/bat
execute if entity @s[nbt={data:{sprite:"bubble"}}] run function baba:display/check_tile/row8/bubble
execute if entity @s[nbt={data:{sprite:"cog"}}] run function baba:display/check_tile/row8/cog
execute if entity @s[nbt={data:{sprite:"icon"}}] run function baba:display/check_tile/row8/icon
...
execute if entity @s[nbt={data:{sprite:"line"}}] run function baba:display/check_tile/row8/line
...
execute if entity @s[nbt={data:{sprite:"bog"}}] run function baba:display/check_tile/row8/bog
execute if entity @s[nbt={data:{sprite:"brick"}}] run function baba:display/check_tile/row8/brick
execute if entity @s[nbt={data:{sprite:"cliff"}}] run function baba:display/check_tile/row8/cliff
