...
execute if entity @s[nbt={data:{sprite:"trees"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.trees.row9","color":"#5c8339"}]'
...
execute if entity @s[nbt={data:{sprite:"husks"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.husks.row9","color":"#90673e"}]'
