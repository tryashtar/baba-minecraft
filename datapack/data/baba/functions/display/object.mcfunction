...
execute if entity @s[scores={sprite=92782899}] run data modify entity @s item.tag.CustomModelData set value 298
execute if entity @s[scores={sprite=320763071}] run data modify entity @s item.tag.CustomModelData set value 298
