...
item modify entity @s container.0 baba:set_model
...
execute store result storage baba:main color int 1 run scoreboard players get color baba
item modify entity @s container.0 baba:set_color
