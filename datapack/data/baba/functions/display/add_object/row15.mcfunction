...
execute if entity @s[nbt={data:{sprite:"ufo"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.ufo.row15","color":"#eb91ca"}]'
...
execute if entity @s[nbt={data:{sprite:"flower"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.flower.row15","color":"#557ae0"}]'
...
execute if entity @s[nbt={data:{sprite:"box"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.box.row15","color":"#c29e46"}]'
...
execute if entity @s[nbt={data:{sprite:"trees"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.trees.row15","color":"#5c8339"}]'
...
execute if entity @s[nbt={data:{sprite:"foliage"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.foliage.row15","color":"#503f24"}]'
...
execute if entity @s[nbt={data:{sprite:"husks"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.husks.row15","color":"#90673e"}]'
execute if entity @s[nbt={data:{sprite:"stump"}}] run data modify storage baba:main text append value '[{"translate":"baba.overlay"},{"translate":"baba.stump.row15","color":"#90673e"}]'
...
execute if entity @s[nbt={data:{sprite:"icon"}}] run function baba:display/add_object/row15/icon
