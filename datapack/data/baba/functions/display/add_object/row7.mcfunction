...
execute if entity @s[scores={sprite=23193}] run function baba:display/add_object/row7/baba
execute if entity @s[scores={sprite=30442}] run function baba:display/add_object/row7/text
execute if entity @s[scores={sprite=45087}] run function baba:display/add_object/row7/keke
execute if entity @s[scores={sprite=61656}] run function baba:display/add_object/row7/me
execute if entity @s[scores={sprite=8465}] run function baba:display/add_object/row7/robot
execute if entity @s[scores={sprite=35402}] run function baba:display/add_object/row7/belt
execute if entity @s[scores={sprite=33425}] run function baba:display/add_object/row7/bird
execute if entity @s[scores={sprite=65488}] run function baba:display/add_object/row7/bug
execute if entity @s[scores={sprite=23664}] run function baba:display/add_object/row7/crab
execute if entity @s[scores={sprite=20987}] run function baba:display/add_object/row7/rocket
execute if entity @s[scores={sprite=61583}] run function baba:display/add_object/row7/skull
execute if entity @s[scores={sprite=44713}] run function baba:display/add_object/row7/ghost
execute if entity @s[scores={sprite=25730}] run function baba:display/add_object/row7/statue
execute if entity @s[scores={sprite=45408}] run function baba:display/add_object/row7/bolt
execute if entity @s[scores={sprite=11302}] run function baba:display/add_object/row7/hand
execute if entity @s[scores={sprite=54043}] run function baba:display/add_object/row7/bat
execute if entity @s[scores={sprite=17246}] run function baba:display/add_object/row7/bubble
execute if entity @s[scores={sprite=22412}] run function baba:display/add_object/row7/cog
execute if entity @s[scores={sprite=48700}] run function baba:display/add_object/row7/cloud
execute if entity @s[scores={sprite=26472}] run function baba:display/add_object/row7/fence
execute if entity @s[scores={sprite=30894}] run function baba:display/add_object/row7/grass
execute if entity @s[scores={sprite=52941}] run function baba:display/add_object/row7/hedge
execute if entity @s[scores={sprite=26372}] run function baba:display/add_object/row7/ice
execute if entity @s[scores={sprite=28861}] run function baba:display/add_object/row7/lava
execute if entity @s[scores={sprite=42043}] run function baba:display/add_object/row7/water
execute if entity @s[scores={sprite=58667}] run function baba:display/add_object/row7/bog
execute if entity @s[scores={sprite=60823}] run function baba:display/add_object/row7/line
execute if entity @s[scores={sprite=40985}] run function baba:display/add_object/row7/pipe
execute if entity @s[scores={sprite=27096}] run function baba:display/add_object/row7/rubble
execute if entity @s[scores={sprite=49468}] run function baba:display/add_object/row7/wall
execute if entity @s[scores={sprite=41172}] run function baba:display/add_object/row7/brick
execute if entity @s[scores={sprite=32467}] run function baba:display/add_object/row7/cliff
...
execute if entity @s[scores={sprite=30442}] run function baba:display/add_object/row7/text.overlay
execute if entity @s[scores={sprite=26837}] run function baba:display/add_object/row7/level.overlay
