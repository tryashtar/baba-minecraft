...
execute at @e[type=#baba:object,tag=baba.object,tag=prop.win] if predicate baba:10_percent run summon item_display ~ ~0.1 ~ {width:2f,height:0.1f,item_display:"fixed",Tags:["baba.particle","win_particle"]}
execute at @e[type=#baba:object,tag=baba.object,tag=prop.tele] if predicate baba:5_percent run summon item_display ~ ~0.1 ~ {width:2f,height:0.1f,item_display:"fixed",Tags:["baba.particle","tele_particle"]}
