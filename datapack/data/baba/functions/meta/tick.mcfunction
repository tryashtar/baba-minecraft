...
execute at @e[type=item_display,tag=baba.object,tag=prop.tele] if predicate baba:5_percent run summon item_display ~ ~0.1 ~ {width:2f,height:0.1f,item_display:"fixed",Tags:["particle","tele_particle"]}
