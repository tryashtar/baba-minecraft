...
data modify storage baba:main object_text set from entity @s item.tag.text
item modify entity 89fd5d65-fc19-4848-8c51-e72ea0c1d85c weapon.mainhand baba:dev/text_display_name
execute positioned ~ ~0.25 ~ run data modify entity @e[type=area_effect_cloud,tag=rule_display,tag=spawn,distance=..0.1,limit=1] CustomName set from entity 89fd5d65-fc19-4848-8c51-e72ea0c1d85c item.tag.display.Name
...
data modify entity @e[type=area_effect_cloud,tag=rule_display,tag=spawn,distance=..0.1,limit=1] CustomName set from entity 89fd5d65-fc19-4848-8c51-e72ea0c1d85c item.tag.display.Name
...
execute positioned ~ ~0.5 ~ run data modify entity @e[type=area_effect_cloud,tag=rule_display,tag=spawn,distance=..0.1,limit=1] CustomName set from entity 89fd5d65-fc19-4848-8c51-e72ea0c1d85c item.tag.display.Name
