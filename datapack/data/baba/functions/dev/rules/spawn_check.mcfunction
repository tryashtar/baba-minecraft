...
execute as @e[type=text_display,tag=rule_display] if score @s text_id = debug_id baba run function baba:dev/rules/update
execute if score spawn baba matches 1 run function baba:dev/rules/spawn
