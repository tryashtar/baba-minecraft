...
execute store result score hash baba run data get storage baba:main iter_rules[0].subject.sprite
...
execute store result score hash baba run data get storage baba:main iter_rules[0].verb
function baba:dev/rules/unhash
data modify storage baba:main rule append from storage baba:main object_text
...
execute store result score hash baba run data get storage baba:main iter_rules[0].effect.text
function baba:dev/rules/unhash
data modify storage baba:main rule append from storage baba:main object_text
