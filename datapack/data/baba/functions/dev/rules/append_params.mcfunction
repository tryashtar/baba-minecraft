...
data modify storage baba:main rule append from storage baba:main object.text_text[]
...
execute if data storage baba:main condition.parameters[0] run function baba:dev/rules/append_params
