loot spawn ~ ~ ~ mine ~ ~-1 ~
execute if data block ~ ~-1 ~ Items[0] run data modify entity @e[type=item,distance=..1,sort=nearest,limit=1] Item.components.block_entity_data.Items set from block ~ ~-1 ~ Items
