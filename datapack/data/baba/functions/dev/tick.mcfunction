execute as @e[type=item,tag=!loaded] if data entity @s Item.components."minecraft:block_entity_data".RecordItem.components."minecraft:custom_data".baba.tiles run function baba:dev/load_jukebox
...
kill @e[type=marker,tag=spawn_copier]

execute as @a[tag=scrub] run function baba:dev/scrub
