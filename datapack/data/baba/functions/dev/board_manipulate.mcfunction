...
scoreboard players add @e[type=item_display,tag=baba.object,scores={sprite=349615},distance=..0.1] text_id 0
tag @e[type=item_display,tag=baba.object,scores={sprite=349615,text_id=0},distance=..0.1] add new_text
scoreboard players operation @e[type=item_display,tag=baba.object,tag=new_text,distance=..0.1] text_id > @e[type=item_display,tag=baba.object,scores={sprite=349615}] text_id
