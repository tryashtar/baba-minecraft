...
execute if data storage baba:main condition.parameters[0] run data modify storage baba:main rule append value "and"
execute if data storage baba:main condition.parameters[0] run function baba:dev/print_params
