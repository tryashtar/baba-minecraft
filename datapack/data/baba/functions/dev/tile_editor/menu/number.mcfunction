...
summon text_display ~-0.5 ~0.2 ~ {text:'{"score":{"name":"@e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1]","objective":"number"}}',alignment:"center",transformation:{translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu","number"]}
summon text_display ~-0.5 ~0.2 ~-0.4 {text:'"↓"',alignment:"center",transformation:{translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu"]}
...
summon text_display ~-0.5 ~-0.2 ~ {text:'"-"',alignment:"center",transformation:{translation:[0f,0f,0f],scale:[1f,1f,1f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu","style"]}
