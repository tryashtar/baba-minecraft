...
summon text_display ~-0.5 ~-0.2 ~ {text:'"-"',transformation:{translation:[0f,0f,0f],scale:[1f,1f,1f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu","style"]}
