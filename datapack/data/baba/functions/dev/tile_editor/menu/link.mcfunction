...
summon text_display ~-0.5 ~-0.5 ~ {text:'{"storage":"baba:main","nbt":"level_name","interpret":true}',transformation:{translation:[0f,0f,0f],scale:[1.5f,1.5f,1.5f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu","name"]}
