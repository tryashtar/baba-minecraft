...
execute as @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] if score @s sprite matches 6491892 run summon text_display ~ ~ ~ {text:'"number"',transformation:{translation:[1.14f,0.5f,0.5f],scale:[0.8f,0.8f,0.8f],left_rotation:[0f,-0.707f,0f,0.707f],right_rotation:[0f,0f,0f,1f]},background:-16777216,Tags:["tile_editor_menu"]}
