...
execute as @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] at @s store result block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.scores.number int 1 run scoreboard players get @s number
...
execute at @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] unless data block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags run data modify block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags set value []
...
execute at @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] if data block ~ ~-1 ~ Items[0] store result score loop baba run data get block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags
...
execute as @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] at @s[tag=style.digit] run data modify block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags append value "style.digit"
...
execute as @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] at @s[tag=style.letter] run data modify block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags append value "style.letter"
...
execute as @e[type=item_display,tag=baba.object,tag=tile_editor_preview,sort=nearest,limit=1] at @s[tag=style.dice] run data modify block ~ ~-1 ~ Items[0].components."minecraft:custom_data".extra.tags append value "style.dice"
