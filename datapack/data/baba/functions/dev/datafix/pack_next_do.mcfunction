...
data modify storage baba:main level set from entity @e[type=item,tag=level,distance=..0.1,limit=1] Item.tag.BlockEntityTag
data modify block ~-1 ~-1 ~1 {} merge from storage baba:main level
kill @e[type=item,tag=level,distance=..0.1,limit=1]
execute at @e[type=marker,tag=baba.storage] run setblock ~ ~ ~ air
execute at @e[type=marker,tag=baba.storage] run setblock ~ ~ ~ jukebox
execute at @e[type=marker,tag=baba.storage] run data modify block ~ ~ ~ {} merge from storage baba:main level
