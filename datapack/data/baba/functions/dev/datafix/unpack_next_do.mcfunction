...
data modify storage baba:main level set from block ~-1 ~-1 ~2 RecordItem.tag
function baba:editor/unpack/grid
execute store result score height baba run data get block ~-1 ~-1 ~2 RecordItem.tag.tiles
execute store result score width baba run data get block ~-1 ~-1 ~2 RecordItem.tag.tiles[0]
execute store result score saved baba if data block ~-1 ~-1 ~2 RecordItem.tag.tiles[][][]
