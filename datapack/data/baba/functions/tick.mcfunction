...
execute unless score last_anim baba = anim baba run function baba:update_anim
execute as @a[nbt={SelectedItem:{id:"minecraft:diamond"}}] at @s run function baba:check_move
