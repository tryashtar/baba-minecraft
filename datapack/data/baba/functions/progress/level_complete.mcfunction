...
execute store result score changed baba run data modify storage baba:main check_complete[] set from storage baba:main last_level
execute if score changed baba >= count baba run data modify storage baba:main completed_levels append from storage baba:main last_level
