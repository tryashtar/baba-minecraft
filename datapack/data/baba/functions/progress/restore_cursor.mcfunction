...
execute store success score different baba run data modify storage baba:main check_level set from entity @s item.components."minecraft:custom_data".baba.level_data.link
