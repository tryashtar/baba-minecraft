...
execute at @e[type=marker,tag=baba.storage,limit=1] run data modify storage baba:main level_name set from block ~ ~ ~ RecordItem.components."minecraft:custom_data".baba.metadata.name
