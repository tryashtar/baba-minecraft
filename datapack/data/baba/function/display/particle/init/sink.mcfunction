item replace entity @s contents with splash_potion[custom_model_data=794028]
...
data modify storage baba:main merge set value {start_interpolation:-1,interpolation_duration:10,transformation:{translation:[0f,0f,0f]}}
...
execute store result storage baba:main merge.transformation.translation[1] float 0.00001220703125000000 run random value -65536..65536
