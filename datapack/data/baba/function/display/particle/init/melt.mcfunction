item replace entity @s contents with splash_potion[custom_model_data=794019]
...
data modify storage baba:main merge set value {start_interpolation:-1,interpolation_duration:18,transformation:{translation:[0f,0f,0f]}}
...
execute store result storage baba:main merge.transformation.translation[1] float 0.00001525878906250000 run random value -65536..65536
data modify entity @s {} merge from storage baba:main merge
scoreboard players set @s life 18
