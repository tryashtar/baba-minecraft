item replace entity @s contents with splash_potion[custom_model_data=794034]
...
execute store result storage baba:main merge.transformation.translation[1] float 0.00002288818359375000 run random value -65536..65536
