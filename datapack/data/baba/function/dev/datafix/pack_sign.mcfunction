...
execute positioned ~1 ~1 ~-1 run data modify entity @e[type=item,tag=level,distance=..1,limit=1] Item.components."minecraft:block_entity_data".RecordItem.components."minecraft:custom_data".baba set from storage baba:main level
