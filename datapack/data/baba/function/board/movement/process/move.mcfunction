...
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=prop.move,tag=!prop.sleep,tag=move_done,scores={life=1..},x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] remove move_done
