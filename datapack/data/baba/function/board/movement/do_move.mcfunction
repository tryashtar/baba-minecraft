...
scoreboard players operation @e[type=#baba:object,tag=baba.object,tag=active,tag=can_move] facing = @s facing
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=can_move] add has_moved
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=can_move] add dirty
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=can_move] remove can_move
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=swapped] remove swapped
