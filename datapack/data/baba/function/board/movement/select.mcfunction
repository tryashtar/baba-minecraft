...
execute if score complete baba matches 0 run data modify entity @e[type=text_display,tag=baba.text,limit=1,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text set value '[{"storage":"baba:main","nbt":"level_name","interpret":true,"font":"baba:font"},"\\n\\ue000"]'
execute if score complete baba matches 1 run data modify entity @e[type=text_display,tag=baba.text,limit=1,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text set value '[{"storage":"baba:main","nbt":"level_name","interpret":true,"font":"baba:font","color":"#51c957"},"\\n\\ue000"]'
