...
tag @e[type=#baba:object,tag=baba.object,tag=active,tag=swap] remove swap
...
execute at @s as @e[type=#baba:object,tag=baba.object,tag=active,tag=swap] run function baba:board/movement/quick_move_here
