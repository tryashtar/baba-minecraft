...
tag @e[type=#baba:object,tag=baba.object,tag=has_moved] remove has_moved
execute if score empty baba matches 1 run function baba:board/update_empty
execute if entity @e[type=#baba:object,tag=baba.object,tag=assign,limit=1] run function baba:board/rules/assign

execute as @e[type=#baba:object,tag=baba.object,tag=prop.move,tag=!prop.sleep] run scoreboard players operation @s life = @s move_stacks
function baba:board/movement/process/move
execute as @e[type=#baba:object,tag=baba.object,tag=prop.move,tag=!prop.sleep,tag=!move_done] run function baba:board/movement/turn_around
function baba:board/movement/process/move
tag @e[type=#baba:object,tag=baba.object,tag=move_done] remove move_done
tag @e[type=#baba:object,tag=baba.object,tag=has_moved] remove has_moved
execute if score empty baba matches 1 run function baba:board/update_empty
...
execute as @e[type=#baba:object,tag=baba.object,tag=prop.shift] at @s run function baba:board/movement/process/setup_shift
function baba:board/movement/process/shift
tag @e[type=#baba:object,tag=baba.object,tag=move_done] remove move_done
tag @e[type=#baba:object,tag=baba.object,tag=has_moved] remove has_moved
tag @e[type=#baba:object,tag=baba.object,tag=shifting] remove shifting
execute if score empty baba matches 1 run function baba:board/update_empty
...
tag @e[type=#baba:object,tag=baba.object,tag=assign_always] add assign
execute if score direction baba matches 0 run tag @e[type=#baba:object,tag=baba.object,tag=assign_idle] add assign
execute if entity @e[type=item_display,tag=baba.object,tag=reparse,limit=1] run function baba:board/rules/update
execute if entity @e[type=#baba:object,tag=baba.object,tag=assign,limit=1] run function baba:board/rules/assign
execute as @e[type=#baba:object,tag=baba.object,tag=has_transforms] at @s run function baba:board/interact/transform
...
tag @e[type=#baba:object,tag=baba.object,tag=teleported] remove teleported
scoreboard players set teleported baba 0
execute as @e[type=#baba:object,tag=baba.object,tag=prop.tele] at @s run function baba:board/interact/teleport
...
execute as @e[type=#baba:object,tag=baba.object,tag=prop.shift] at @s run function baba:board/interact/shift_dir
execute if score direction baba matches 1.. as @e[type=#baba:object,tag=baba.object,tag=prop.select] at @s run function baba:board/movement/select
execute as @e[type=#baba:object,tag=baba.object,tag=prop.fall] at @s run function baba:board/interact/fall
...
scoreboard players set @e[type=#baba:object,tag=baba.object,tag=prop.up] facing 1
...
execute as @e[type=#baba:object,tag=baba.object,tag=prop.sink] at @s run function baba:board/interact/sink
execute if score sank baba matches 1.. as @a at @s run playsound baba:sink master @s
execute as @e[type=#baba:object,tag=baba.object,tag=prop.weak] at @s run function baba:board/interact/weak
scoreboard players set melted baba 0
execute as @e[type=#baba:object,tag=baba.object,tag=prop.hot] at @s run function baba:board/interact/hot
execute if score melted baba matches 1.. as @a at @s run playsound baba:melt master @s
execute as @e[type=#baba:object,tag=baba.object,tag=prop.defeat] at @s run function baba:board/interact/defeat
execute if score destroyed baba matches 1.. as @a at @s run playsound baba:defeat master @s
execute as @e[type=#baba:object,tag=baba.object,tag=prop.shut] at @s run function baba:board/interact/shut
...
execute as @e[type=#baba:object,tag=baba.object,tag=has_makes] at @s run function baba:board/interact/make
execute if entity @e[type=#baba:object,tag=baba.object,tag=assign,limit=1] run function baba:board/rules/assign

execute as @e[type=#baba:object,tag=baba.object,tag=prop.win] at @s run function baba:board/interact/win
...
execute as @e[type=item_display,tag=baba.object,tag=has_frames,tag=!prop.sleep] run function baba:board/graphics/frame
