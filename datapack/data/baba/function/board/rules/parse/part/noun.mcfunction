...
execute if score word baba matches 4085899 if data storage baba:main parsing.state{noun:"effect"} run data modify storage baba:main parsing.effect_part set value "property"
