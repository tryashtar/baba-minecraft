...
scoreboard players remove @e[type=item_display,tag=baba.object,tag=active,tag=is_text,predicate=baba:match_score/text_id,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled 1
