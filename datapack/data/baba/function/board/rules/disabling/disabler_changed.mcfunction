...
execute if entity @s[tag=!subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=!subject_inverted,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,predicate=baba:match_score/life,predicate=baba:match_score/text,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
# 'ALL is not text' disables 'A write X' unless A is empty/text/level/group
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=!subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=!subject_empty,tag=!subject_text,tag=!subject_level,tag=!subject_group,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
# 'not ALL verb not X' disables 'empty/text/not all verb X'
execute if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=!subject_inverted,tag=subject_empty,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
execute if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=!subject_inverted,tag=subject_text,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
execute if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=subject_inverted,tag=subject_all,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
# 'not ALL is not text' disables 'empty/text/not all write X'
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=subject_empty,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=!subject_inverted,tag=subject_text,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
execute if score life baba matches 262 if score text baba matches 397973 if entity @s[tag=subject_inverted,tag=subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=write_transform,tag=subject_inverted,tag=subject_all,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
...
execute if entity @s[tag=subject_inverted,tag=!subject_all] run scoreboard players operation @e[type=marker,tag=baba.rule,tag=target,tag=subject_inverted,predicate=baba:match_score/life,predicate=baba:match_score/text,predicate=baba:match_score/sprite,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] text_disabled += disable_change baba
