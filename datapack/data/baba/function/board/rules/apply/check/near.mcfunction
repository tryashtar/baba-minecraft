...
execute if score inverted baba matches 0 run tag @e[type=#baba:object,tag=baba.object,tag=!self,tag=!used,predicate=baba:match_score/sprite,distance=..1.5] add found
execute if score inverted baba matches 1 run tag @e[type=#baba:object,tag=baba.object,tag=!self,tag=!used,tag=!not_all,predicate=!baba:match_score/sprite,distance=..1.5] add found
