...
execute if entity @s[tag=!subject_all,tag=!subject_group] run tag @e[type=#baba:object,tag=baba.object,tag=!assign,tag=!not_all,predicate=!baba:match_score/sprite] add assign
