...
execute if entity @s[tag=!subject_inverted] as @e[type=#baba:object,tag=baba.object,tag=active,tag=joined_group,tag=assign,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] at @s run function baba:board/rules/apply/check
execute if entity @s[tag=subject_inverted] as @e[type=#baba:object,tag=baba.object,tag=active,tag=!joined_group,tag=!not_all,tag=assign,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] at @s run function baba:board/rules/apply/check
