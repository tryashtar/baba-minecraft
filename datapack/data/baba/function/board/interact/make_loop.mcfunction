...
execute unless entity @e[type=#baba:object,tag=baba.object,tag=active,predicate=baba:match_score/sprite,distance=..0.1,limit=1] run function baba:board/spawn
