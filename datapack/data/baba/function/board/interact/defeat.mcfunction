...
execute as @e[type=#baba:object,tag=baba.object,tag=active,tag=prop.you,predicate=baba:match_score/float_level,distance=..0.1] run function baba:board/interact/defeated
