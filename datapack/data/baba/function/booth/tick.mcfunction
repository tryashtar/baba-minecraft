execute if score door_status baba matches 0 as @e[type=pig,tag=baba_key,distance=..40,limit=1] at @s if entity @e[type=item_display,tag=baba_door,distance=..0.5,limit=1] run function baba:booth/door_open
