...
tag @e[tag=baba.space,x=63.0,y=67.0,z=-168.0,dx=24,dy=14,dz=1] add dirty
execute as @e[type=marker,tag=baba.board,x=63,y=68,z=-166,distance=..5,limit=1] at @s run function baba:board/history/record
scoreboard players set steps baba 0
