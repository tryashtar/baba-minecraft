...
summon interaction 75.5 76.0 -163.5 {width:1f,height:1f,response:1b,Tags:["baba","baba_demo","baba_restart"]}
...
summon text_display 75.5 74.0 -163.5 {text:'{"text":"continue\\n playing ","font":"baba:font"}',Tags:["baba","baba_menu_text"],alignment:"center",shadow:1b,background:-9787854,transformation:{translation:[0f,-0.2f,0f],scale:[2f,2f,2f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},billboard:"fixed"}
summon text_display 75.5 76.0 -163.5 {text:'{"text":"restart\\n level ","font":"baba:font"}',Tags:["baba","baba_menu_text"],alignment:"center",shadow:1b,background:-7913542,transformation:{translation:[0f,0.2f,0f],scale:[2f,2f,2f],left_rotation:[0f,0f,0f,1f],right_rotation:[0f,0f,0f,1f]},billboard:"fixed"}
