# test "the end" in 48 moves
function baba:levels/load/baba/the_end
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [2,4,4,4,4,4,4,4,1,1,3,3,3,3,3,3,3,2,3,1,2,1,3,3,3,2,4,4,4,4,4,4,4,4,2,4,4,4,4,2,2,2,2,2,2,2,2,2]
