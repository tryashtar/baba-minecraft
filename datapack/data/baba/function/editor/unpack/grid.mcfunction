...
data modify block ~ ~-2 ~ RecordItem.components."minecraft:custom_data".baba set from storage baba:main level.metadata
data remove block ~ ~-2 ~ RecordItem.components."minecraft:custom_data".baba.name
