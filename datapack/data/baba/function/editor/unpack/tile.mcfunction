execute if block ^ ^ ^-1 air run setblock ^ ^ ^-1 black_concrete
execute if block ^ ^ ^-1 #baba:board run setblock ^ ^ ^-1 black_concrete
fill ^ ^ ^ ^ ^ ^10 air
...
execute unless data storage baba:main level.tiles[0][0] if block ^1 ^ ^-1 #baba:editor_floor run setblock ^1 ^ ^-2 air
