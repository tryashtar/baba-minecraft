...
execute at @e[type=#baba:object,tag=baba.object,tag=prop.select] as @e[type=#baba:object,tag=baba.object,distance=..0.1,predicate=baba:has_level_data,limit=1] run function baba:booth/demo/enter_level
