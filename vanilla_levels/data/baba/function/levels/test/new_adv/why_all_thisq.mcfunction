# test "Why all this?" in 53 moves
function baba:levels/load/new_adv/why_all_thisq
data modify storage baba:main level_list set value []
data modify storage baba:main moves_list set value []
data modify storage baba:main moves set value [2,2,4,4,4,4,4,4,1,3,3,1,3,4,2,2,3,1,1,4,4,4,1,3,2,4,4,4,1,3,3,3,3,1,1,3,2,2,2,4,4,4,4,4,4,4,4,1,4,4,3,3,2]
