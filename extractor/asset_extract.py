    ...
    for n, o in enumerate(image_offsets):
        ...
        while file.tell() < end:
            ...
            while True:
                ...
                if file.tell() >= block_start + block_size:
                    break
        Image.frombytes("RGBA", (width, height), bytes(uncompressed)).save(
            os.path.join(out_path, 'images', f'{n}.png'))
