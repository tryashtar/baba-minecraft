...
def main():
   ...
   tat.delete_folder('vanilla_levels/data/baba/function/levels/load')
   tat.delete_folder('vanilla_levels/data/baba/function/levels/test')
   tat.delete_folder('test_levels/data/baba/function/levels/load')
   tat.delete_folder('test_levels/data/baba/function/levels/test')
   for pack in tat.get_folders(os.path.join(baba_folder, 'Data/Worlds')):
      datapack = 'vanilla_levels'
